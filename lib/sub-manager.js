...
SubManager.prototype._addSub = function(args) {
...
SubManager.prototype._applyCacheLimit = function () {
  var self = this;
...
SubManager.prototype._applyExpirations = function() {
  var self = this;
  var newCacheList = [];

  var expirationTime = Date.now() - self.options.expirationTime * 60 * 1000;
  _.each(self._cacheList, function(sub) {
